    ...
    private array $products = [
        ...
        'Action Figures' => [
            ...
            ['Naruto Shippuden Chibi Collection', 'random', 45.00, 31.50, 200, false,
                ['Naruto Uzumaki', 'Sasuke Uchiha', 'Sakura Haruno', 'Kakashi Hatake', 'Rock Lee', 'Hinata Hyuga']],
            ...
            ['Demon Slayer Hashira Collection', 'random', 55.00, 38.50, 180, false,
                ['Tanjiro Kamado', 'Nezuko Kamado', 'Zenitsu Agatsuma', 'Inosuke Hashibira', 'Rengoku Kyojuro', 'Tengen Uzui']],
            ...
            ['Jujutsu Kaisen Sorcerers Vol.1', 'random', 49.00, 34.30, 220, true,
                ['Yuji Itadori', 'Megumi Fushiguro', 'Nobara Kugisaki', 'Satoru Gojo', 'Ryomen Sukuna', 'Nanami Kento']],
            ...
            ['Hunter x Hunter Trading Figures', 'random', 52.00, 36.40, 150, false,
                ['Gon Freecss', 'Killua Zoldyck', 'Kurapika', 'Leorio Paradinight', 'Hisoka', 'Meruem']],
        ],
        ...
        'Anime & Manga' => [
            ...
            ['Chainsaw Man Devil Collection', 'random', 58.00, 40.60, 160, false,
                ['Denji (Chainsaw Man)', 'Makima', 'Power', 'Aki Hayakawa', 'Kobeni', 'Beam']],
            ...
            ['Bleach Thousand-Year Blood War Set', 'random', 62.00, 43.40, 140, true,
                ['Ichigo Kurosaki', 'Rukia Kuchiki', 'Byakuya Kuchiki', 'Kenpachi Zaraki', 'Yhwach', 'Uryu Ishida']],
            ['Fairy Tail Guild Members Collection', 'random', 48.00, 33.60, 190, false,
                ['Natsu Dragneel', 'Lucy Heartfilia', 'Erza Scarlet', 'Gray Fullbuster', 'Happy', 'Mavis Vermillion']],
            ...
            ['Black Clover Magic Knights Series', 'random', 45.00, 31.50, 200, false,
                ['Asta', 'Yuno', 'Noelle Silva', 'Yami Sukehiro', 'Luck Voltia', 'Magna Swing']],
        ...
        'Cute Animals' => [
            ['Shiba Inu Expressions Vol.4', 'random', 39.00, 27.30, 250, true,
                ['Happy Doge', 'Shocked Doge', 'Smug Doge', 'Sleepy Doge', 'Angry Doge', 'Confused Doge']],
            ['Capybara Relaxing Situations', 'random', 42.00, 29.40, 230, false,
                ['Capybara in Hot Spring', 'Capybara with Friends', 'Capybara Napping', 'Capybara Eating', 'Capybara Floating']],
            ['Corgi Butts Wiggle Collection', 'random', 35.00, 24.50, 280, true,
                ['Classic Pembroke Butt', 'Cardigan Butt', 'Wiggle Walk', 'Sit & Wag', 'Zoomies Pose', 'Belly Up']],
            ['Hamster in Tiny Places', 'random', 38.00, 26.60, 260, false,
                ['Hamster in a Cup', 'Hamster in a Shoe', 'Hamster in a Hat', 'Hamster in a Bag', 'Hamster in a Pocket']],
            ['Cat Life Moments Vol.6', 'random', 36.00, 25.20, 300, false,
                ['Loaf Cat', 'Sploot Cat', 'Box Cat', 'Window Cat', 'Midnight Zoomies Cat', 'Judge-y Cat']],
            ['Fluffy Rabbit Friends Series', 'random', 40.00, 28.00, 240, false,
                ['Lop Ear Bunny', 'Holland Lop', 'Rex Bunny', 'Angora Fluff', 'Dwarf Bunny', 'Wild Hare']],
            ['Penguin Waddle Parade', 'random', 37.00, 25.90, 270, false,
                ['Emperor Penguin', 'Little Blue Penguin', 'Macaroni Penguin', 'Chinstrap Penguin', 'Rockhopper']],
            ['Frog on Objects Collection', 'random', 35.00, 24.50, 290, false,
                ['Frog on a Mushroom', 'Frog on a Lily Pad', 'Frog on a Coin', 'Frog on a Strawberry', 'Frog on a Pencil']],
            ['Baby Alpaca Nap Time', 'random', 44.00, 30.80, 210, false,
                ['White Fluffy Alpaca', 'Brown Alpaca', 'Spotted Alpaca', 'Alpaca in Scarf', 'Baby Alpaca Cria']],
            ['Otter Floating Family Set', 'random', 41.00, 28.70, 225, false,
                ['Sea Otter Holding Hands', 'River Otter Pup', 'Otter with Shell', 'Otter Eating Clam', 'Otter Backfloat']],
        ],

        'Food Miniatures' => [
            ['HK Dim Sum Feast Collection', 'random', 55.00, 38.50, 180, true,
                ['Har Gow (Shrimp Dumpling)', 'Siu Mai', 'Char Siu Bao', 'Cheung Fun', 'Egg Tart', 'Lo Bak Go']],
            ...
            ['Bubble Tea Flavours Series', 'random', 42.00, 29.40, 220, false,
                ['Classic Milk Tea', 'Taro Milk Tea', 'Matcha Latte', 'Brown Sugar Boba', 'Strawberry Slush', 'Mango Yakult']],
            ['Ramen Bowl Detail Collection', 'random', 48.00, 33.60, 195, false,
                ['Tonkotsu Ramen', 'Shoyu Ramen', 'Miso Ramen', 'Spicy Tan Tan', 'Tsukemen Dipping', 'Hokkaido Butter']],
            ['HK Street Food Miniatures', 'random', 45.00, 31.50, 210, false,
                ['Curry Fish Balls', 'Egg Waffle', 'Siu Yeh Pork Chop', 'Dragon\'s Beard Candy', 'Stinky Tofu', 'Pineapple Bun']],
            ['Matcha Sweets Parfait Set', 'random', 40.00, 28.00, 240, false,
                ['Matcha Parfait', 'Matcha Roll Cake', 'Matcha Mochi', 'Matcha Tiramisu', 'Matcha Soft Serve']],
            ...
            ['Ice Cream World Flavours', 'random', 38.00, 26.60, 260, false,
                ['Vanilla Cone', 'Chocolate Swirl', 'Strawberry Scoop', 'Mint Choc Chip', 'Rocky Road Cup', 'Mochi Ice Cream']],
            ['Japanese Convenience Store Snacks', 'random', 44.00, 30.80, 200, false,
                ['Onigiri (Salmon)', 'Onigiri (Tuna Mayo)', 'Melon Pan', 'Tamagoyaki Sandwich', 'Pocky Box', 'Ramune Bottle']],
        ...
        'Robots & Mechas' => [
            ...
            ['Mazinger Z Classic Villain Pack', 'random', 68.00, 47.60, 120, false,
                ['Mazinger Z', 'Great Mazinger', 'UFO Robot Grendizer', 'Getter Robo', 'Baron Ashura', 'Dr. Hell']],
            ...
            ['Iron Man Hall of Armour Mini', 'random', 72.00, 50.40, 130, false,
                ['Mark I (Cave Armour)', 'Mark III (Classic Red)', 'War Machine', 'Iron Patriot', 'Hulkbuster', 'Nanotech Mark L']],
        ],

        'Fantasy & Magic' => [
            ['Princess Mononoke Forest Spirits', 'random', 62.00, 43.40, 140, true,
                ['San (Princess Mononoke)', 'Ashitaka', 'The Great Forest Spirit', 'Kodama (Tree Spirit)', 'Moro the Wolf God', 'Eboshi']],
            ['Spirited Away Spirit Collection', 'random', 58.00, 40.60, 155, true,
                ['Chihiro (Sen)', 'Haku Dragon', 'No-Face (Kaonashi)', 'Yubaba', 'Boh', 'Lin & Kamaji']],
            ...
            ['Witch\'s Potion Bottles Series', 'random', 45.00, 31.50, 200, false,
                ['Love Potion No.9', 'Invisibility Brew', 'Dragon\'s Breath Flask', 'Moonwater Vial', 'Cursed Ink Bottle', 'Healing Elixir']],
            ['Mythical Creatures Blind Box', 'random', 52.00, 36.40, 170, false,
                ['Unicorn', 'Griffin', 'Kirin (Qilin)', 'Phoenix', 'Pegasus', 'Sea Serpent']],
            ['Dungeons & Dragons Monster Box', 'random', 65.00, 45.50, 135, false,
                ['Beholder', 'Mind Flayer', 'Owlbear', 'Mimic Chest', 'Gelatinous Cube', 'Tarrasque']],
            ['Enchanted Forest Beings', 'random', 48.00, 33.60, 185, false,
                ['Wood Elf Archer', 'Forest Sprite', 'Treant Elder', 'Will-o\'-Wisp', 'Faerie Dragon', 'Dryad']],
        ...
        'Retro & Vintage' => [
            ...
            ['80s Pop Culture Nostalgia Box', 'random', 55.00, 38.50, 160, true,
                ['Rubik\'s Cube', 'Walkman Yellow', 'He-Man Mini', 'Ghostbusters Proton Pack', 'Back to the Future DeLorean', 'Tetris Game Boy']],
            ...
            ['Retro Robot Wind-Up Series', 'random', 62.00, 43.40, 130, false,
                ['Silver Tin Robot', 'Red Rocket Bot', 'Gold Commander Bot', 'Blue Space Patrol', 'Green Atomic Robot']],
            ...
            ['Vintage Space Age Collectibles', 'random', 58.00, 40.60, 145, false,
                ['Apollo 11 Lunar Module', 'Sputnik Satellite', 'Vostok Capsule', 'Space Shuttle Discovery', 'Voyager Probe', 'Mir Station']],
            ...
            ['Classic Pinball Machine Minis', 'random', 65.00, 45.50, 120, false,
                ['Medieval Castle Table', 'Space Invaders Table', 'Wild West Table', 'Haunted Mansion Table', 'Rock \'n\' Roll Table']],
        ],
        ...
        'Sci-Fi & Space' => [
            ...
            ['Cosmic Horror Figures Vol.1', 'random', 68.00, 47.60, 125, true,
                ['Cthulhu Rising', 'Shoggoth Blob', 'Deep One Hybrid', 'Nyarlathotep', 'Mi-Go Brain Cylinder', 'Elder Thing']],
            ['Starship Collection Series', 'random', 72.00, 50.40, 115, false,
                ['USS Enterprise NCC-1701', 'Millennium Falcon', 'Serenity (Firefly)', 'Nostromo (Alien)', 'Discovery One', 'Battlestar Galactica']],
            ...
            ['Alien Worlds Creature Box', 'random', 58.00, 40.60, 150, false,
                ['Grey Alien', 'Predator (Unmasked)', 'Xenomorph Warrior', 'Na\'vi Warrior', 'Borg Drone', 'Klingon Warrior']],
            ...
            ['Deep Sea vs. Space Explorer', 'random', 55.00, 38.50, 165, false,
                ['Giant Squid (Deep Sea)', 'Anglerfish (Deep Sea)', 'Dumbo Octopus (Deep Sea)', 'Mars Rover (Space)', 'Spacewalker (Space)', 'Comet (Space)']],
        ],
        ...
        'Kawaii Lifestyle' => [
            ...
            ['Hello Kitty Through the Years', 'random', 65.00, 45.50, 140, true,
                ['Classic White (1974)', 'Strawberry Hello Kitty', 'Space Hello Kitty', 'Wedding Hello Kitty', 'Kimono Hello Kitty', 'Rock Star Hello Kitty']],
            ['Pompompurin Nap Time Series', 'random', 45.00, 31.50, 210, false,
                ['Pompompurin on Sofa', 'Pompompurin in Hammock', 'Pompompurin Under Blanket', 'Pompompurin in Box', 'Pompompurin with Macaroon']],
            ['My Melody Kitchen Life', 'random', 42.00, 29.40, 225, false,
                ['My Melody Baking', 'My Melody Tea Time', 'My Melody Grocery Run', 'My Melody Lunch Box', 'My Melody Cooking']],
            ['Keroppi Pond Adventures', 'random', 40.00, 28.00, 240, false,
                ['Keroppi Lily Pad Nap', 'Keroppi Catching Fireflies', 'Keroppi Rainy Day', 'Keroppi Picnic', 'Keroppi Swimming']],
            ['Gudetama Existential Crisis', 'random', 38.00, 26.60, 260, false,
                ['Gudetama in Egg Shell', 'Gudetama on Rice', 'Gudetama Bacon Blanket', 'Gudetama in Frying Pan', 'Gudetama Sunny-Side Up']],
            ...
            ['Pochacco Sports Champions', 'random', 42.00, 29.40, 220, false,
                ['Pochacco Soccer', 'Pochacco Tennis', 'Pochacco Swimming', 'Pochacco Basketball', 'Pochacco Track & Field']],
        ...
        'Limited Edition' => [
            ...
            ['Christmas Winter Wonderland Box', 'random', 78.00, 54.60, 100, true,
                ['Santa on Sleigh', 'Snowman Family', 'Reindeer Rudolph', 'Christmas Elf Workshop', 'Nutcracker Guard', 'Gingerbread House']],
            ['Halloween Spooky Surprise Set', 'random', 72.00, 50.40, 110, false,
                ['Jack-o\'-Lantern Ghost', 'Vampire Count', 'Witch on Broomstick', 'Friendly Mummy', 'Black Cat Witch', 'Frankenstein\'s Monster']],
            ...
            ['Cherry Blossom Hanami Season', 'random', 65.00, 45.50, 120, false,
                ['Sakura Picnic Couple', 'Sakura Tea Ceremony', 'Sakura Mochi Snack', 'Torii Gate in Bloom', 'Sakura Viewing Bench', 'Petal Drift Scene']],
            ...
            ['Mid-Autumn Festival Moon Box', 'random', 88.00, 61.60, 90, false,
                ['Full Moon Rabbit', 'Mooncake Set', 'Lantern Parade', 'Chang\'e & Jade Rabbit', 'Paper Lantern Float', 'Moon Gate Garden']],
            ...
            ['Summer Matsuri Festival Series', 'random', 62.00, 43.40, 115, false,
                ['Goldfish Scooping Stall', 'Yukata Festival Girl', 'Taiko Drummer', 'Fireworks Viewing', 'Kakigori Shaved Ice', 'Bon Odori Dance']],
    ...
    private function seedProducts(array $brands, array $categories): int
    {
        ...
        foreach ($this->products as $categoryName => $productList) {
            ...
            foreach ($productList as [$name, $type, $price, $wholesale, $stock, $featured, $variants]) {
                ...
                // Create variants for both specific and random type products
                if (! empty($variants)) {
